        ...
        input: {
            ...
            participants: [
                ...
                },
                {
                  reference: "...",
                  evidenceValidation: [
                    {key: "cprNumberIdentifier", value: "2233440000"}
                  ]
                }
            ]
        }
...
Our [GraphQL Explorer](https://signatures-api-test.azurewebsites.net/v1/explorer) is the easiest way to test out queries.
